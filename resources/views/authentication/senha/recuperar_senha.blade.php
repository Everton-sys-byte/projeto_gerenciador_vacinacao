...
@section('content')
    <div class="page container-fluid p-3 d-flex justify-content-center align-items-center"
        ...
        <x-form.default-form formAction="{{ @route('send.password.recovery.email') }}" formMethod="POST" class="bg-light py-3 px-4 rounded"
            ...
            <span class="fs-2 text-primary text-center">Recuperar conta</span>
            <article>
                Por favor, preencha o seu email corretamente, depois disso irá ser enviado uma mensagem para a
                recuperação
                de senha.
            </article>
