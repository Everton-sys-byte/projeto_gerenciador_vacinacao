...
@section('content')
    <div class="page container-fluid p-3 d-flex justify-content-center align-items-center"
        ...
        <x-form.default-form formAction="{{ @route('user.autenticar') }}" formMethod="POST" class="bg-light py-3 px-4" formId
            ...
            <div class="password-register">
                <p>Esqueceu a senha?&nbsp;<a href="{{ @route('password.recovery') }}" class="text-decoration-none">clique
                        aqui</a>
